...
<html>
    ...
    <script>
        $(function () {
            ...
            $(".fileToUpload").on("change",function(){
        		...
        		(	
        			{
        				url:'vesselAnnualMaintain_upLoad.action?id=<s:property value="id"/>&fileDetailName='+fileName,
	...
	<s:form autocomplete="off" action="vesselAnnualMaintain_addFile" enctype="multipart/form-data">
            ...
            <tr>
                ...
                <td>
                	<div class = "judgeHidden">
              		 <s:a action="vesselAnnualMaintain_downLoad?fileDetailName=vesselThiTestPic&id=%{id}">

...
<html>
	...
	<s:form  action="pipeLeakTest_edit" >
		<s:hidden name="id"></s:hidden>
		<s:hidden name="pipeMaintainId"></s:hidden>
        <table class="table table-striped table-bordered table-condensed list" >
        <thead >
        <tr>
            <td colspan="8" id="center"><b>泄露性检查</b><a id="startEdit" >修改</a></td>
        </tr>
        </thead>
         <tr>
             <td colspan="2">试验介质</td>
             <td colspan="2"> 
        ...
        <tr>
	         <td colspan="2">泄露性试验结论
	         </td>
	         <td colspan="6">
	          <s:textarea name="p_Leak_Result" cssClass="span2 inputClass" style="height:90px"/>
	         </td>
        </tr>           
 		<tr>
            <td colspan="2">检验</td>
            ...
            <div class="input-append">
                 <s:textfield  cssClass="datepicker inputClass" name="p_Leak_Data"/>

...
<html>
	...
	<s:form  action="pipeOnlineThiTest_edit" >
        ...
        <tr>
            ...
            <tr>
             ...
             <tr style="display:none">
              ...
              <tr>
                <td colspan="2">上次在线检验报告编号</td>
                <td colspan="2"> 
                <s:textfield cssClass="span2 inputClass" name="m_Ol_Last_ID" />
                </td>
                <td colspan="2">上次在线检验单线图编号</td>
                <td colspan="2">
                <s:textfield cssClass="span2 inputClass" name="m_OL_Single_ID" />
                </td>  
            </tr> 

...
public class VesselBasic {
	...
	private Company v_Use_Com;//使用单位
	private Company v_De_Com;//设计单位
	private Company v_Man_Com;//制造单位
	private Company v_Install_Com;//安装单位
	...
	private Set<VesselMaintain> vesselMaintain;//检验记录
	
	private Set<VesselMonthlyInspection> vesselMonthlyInspections;//月度检验记录
	
	/**
	 * @return the vesselMonthlyInspections
	 */
	@OneToMany(mappedBy="vesselBasic", orphanRemoval=true , cascade=CascadeType.MERGE)
	public Set<VesselMonthlyInspection> getVesselMonthlyInspections() {
		return vesselMonthlyInspections;
	}
	/**
	 * @param vesselMonthlyInspections the vesselMonthlyInspections to set
	 */
	public void setVesselMonthlyInspections(
			Set<VesselMonthlyInspection> vesselMonthlyInspections) {
		this.vesselMonthlyInspections = vesselMonthlyInspections;
	}
	/**
	 * @return the vesselMaintain
	 */
	@OneToMany(mappedBy="vesselBasic", orphanRemoval=true , cascade=CascadeType.MERGE)
	public Set<VesselMaintain> getVesselMaintain() {
		return vesselMaintain;
	}
	/**
	 * @param vesselMaintain the vesselMaintain to set
	 */
	public void setVesselMaintain(Set<VesselMaintain> vesselMaintain) {
	...
	@JoinColumn(name="useCompanyId")
	public Company getV_Use_Com() {
		return v_Use_Com;
	}
	/**
	 * @param v_Use_Com the v_Use_Com to set
	 */
	public void setV_Use_Com(Company v_Use_Com) {
	 ...
	 */
	@ManyToOne(cascade=CascadeType.ALL)
	@JoinColumn(name="designCompanyId")
	public Company getV_De_Com() {
		return v_De_Com;
	}
	/**
	 * @param v_De_Com the v_De_Com to set
	 */
	public void setV_De_Com(Company v_De_Com) {
	 ...
	 */
	@ManyToOne(cascade=CascadeType.ALL)
	@JoinColumn(name="manufactureCompanyId")
	public Company getV_Man_Com() {
		return v_Man_Com;
	}
	/**
	 * @param v_Man_Com the v_Man_Com to set
	 */
	public void setV_Man_Com(Company v_Man_Com) {
	 ...
	 */
	@ManyToOne(cascade=CascadeType.ALL)
	@JoinColumn(name="installCompanyId")
	public Company getV_Install_Com() {
		return v_Install_Com;
	}
	/**
	 * @param v_Install_Com the v_Install_Com to set
	 */
	public void setV_Install_Com(Company v_Install_Com) {

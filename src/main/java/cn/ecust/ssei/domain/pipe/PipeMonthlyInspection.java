...
@Entity
@Table(name="ssei_pipeMonthlyInspection")
public class PipeMonthlyInspection {
	
	private long id;
	private String v_Date;
	private String v_Problem;
	private String v_Persion;	
	private PipeBasic pipeBasic; 
	...
	/**
	 * @param pipeBasic the pipeBasic to set
	 */
	...
	public String toString() {
		return "PipeMonthlyInspection [id=" + id + ", v_Date=" + v_Date
				+ ", v_Problem=" + v_Problem + ", v_Persion=" + v_Persion
				+ ", pipeBasic=" + pipeBasic + ", v_Result_1=" + v_Result_1

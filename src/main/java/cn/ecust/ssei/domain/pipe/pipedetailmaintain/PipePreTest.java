...
@Entity
@Table(name="ssei_pipePreTest")
public class PipePreTest {

private long id;//压力检测ID
...
private String p_Pre_Result;//压力试验结论
private String p_Pre_Data;//压力检测日期
/**
 * @return the id
 */
@Id
...
/**
 * @return the p_Pre_Result
 */
public String getP_Pre_Result() {
	return p_Pre_Result;
}
/**
 * @param p_Pre_Result the p_Pre_Result to set
 */
public void setP_Pre_Result(String p_Pre_Result) {
	this.p_Pre_Result = p_Pre_Result;
}
/**
 * @return the p_Pre_Data
 */
public String getP_Pre_Data() {
	return p_Pre_Data;
}
/**
 * @param p_Pre_Data the p_Pre_Data to set
 */
public void setP_Pre_Data(String p_Pre_Data) {
	this.p_Pre_Data = p_Pre_Data;
}
/* (non-Javadoc)
...
public String toString() {
	return "PipePreTest [id=" + id + ", pipeDetailMaintain="
			+ pipeDetailMaintain + ", p_Max_Pre=" + p_Max_Pre + ", p_Exp_Med="
			+ p_Exp_Med + ", p_Exp_Pre=" + p_Exp_Pre + ", p_Med_Tem="
			+ p_Med_Tem + ", p_Amb_Tem=" + p_Amb_Tem + ", p_Pump_Pre_Cri="
			+ p_Pump_Pre_Cri + ", p_Pump_Pre_Acc=" + p_Pump_Pre_Acc
			+ ", p_Line_Pre_Cri=" + p_Line_Pre_Cri + ", p_Line_Pre_Acc="
			+ p_Line_Pre_Acc + ", p_Pump_Type=" + p_Pump_Type + ", p_Ope_Cri="
			+ p_Ope_Cri + ", p_Pre_Result=" + p_Pre_Result + ", p_Pre_Data="
			+ p_Pre_Data + "]";
}

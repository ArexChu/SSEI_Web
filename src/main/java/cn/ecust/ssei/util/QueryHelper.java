...
public class QueryHelper {
	 ...
	 *            别名
	 */
	public QueryHelper(@SuppressWarnings("rawtypes") Class clazz, String alias) {
	...
	public List getListInPageBean(DaoSupport<?> service) {
		return service.getListInPageBean(this);
	}
